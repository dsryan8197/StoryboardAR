              ...
              <Grid>
                <Row size={1}>
                  ...
                  {!this.props.Info.images &&
                    <Text style={{ fontSize: 15, color: 'white', position: 'absolute', right: '28%', top: '46%' }}>To move your characters</Text>
                    <Text style={{ fontSize: 15, color: 'white', position: 'absolute', right: '10%', top: '50%' }}>Tap, hold and move your phone through the space</Text>
                  } */}
    ...
    if (this.state.navigator == 'Positions') {
      ...
      if (this.state.chosenModel) {
        for (let i = 0; i < modelArray[this.state.chosenModel - 1].models.length; i++) {
          stance.push(
            <TouchableHighlight loading="lazy" key={i} onPress={() => {
              (this.setState((prevState) => ({
                ...prevState,
